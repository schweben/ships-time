...
describe('Watch', () => {
    ...
    // it('should return 2059 as 1 bell of the First Watch', () => {
    //     const watch = new Watch('First watch', 20, 0);
    //     const time = new Date(2018, 4, 13, 20, 59, 0, 0);
    //     expect(watch.isTimeInWatch(time)).toBeTruthy();
    //     expect(watch.getBells(time)).toBe(1);
    // });

    // it('should return 2100 as 2 bells of the First Watch', () => {
    //     const watch = new Watch('First watch', 20, 0);
    //     const time = new Date(2018, 4, 13, 21, 0, 0, 0);
    //     expect(watch.isTimeInWatch(time)).toBeTruthy();
    //     expect(watch.getBells(time)).toBe(2);
    ...
    // it('should return 2101 as 2 bells of the First Watch', () => {
    //     const watch = new Watch('First watch', 20, 0);
    //     const time = new Date(2018, 4, 13, 21, 1, 0, 0);
    //     expect(watch.isTimeInWatch(time)).toBeTruthy();
    //     expect(watch.getBells(time)).toBe(2);
    // });

    // it('should return 2359 as 7 bells of the first watch', () => {
    //     const watch = new Watch('First watch', 20, 0);
    ...
    // it('should return 0000 as 8 bells of the first watch', () => {
    //     const watch = new Watch('First watch', 20, 0);
    //     const time = new Date(2018, 4, 13, 0, 0, 0, 0);
    //     expect(watch.isTimeInWatch(time)).toBeTruthy();
    //     expect(watch.getBells(time)).toBe(8);
    ...
    // it('should return 0001 as 8 bells of the first watch', () => {
    ...
    // it('should return 0030 as 1 bell of the middle watch', () => {
    //     const watch = new Watch('Middle watch', 0, 4);
