...
describe('Test that watches are defined correctly', () => {
    ...
    test('Correct number of watches', () => {
        expect(timeService.getWatches().length).toBe(7);
    });

    test('First watch between 20:00 and 00:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'First Watch');
    ...
    test('Middle watch between 00:00 and 04:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'Middle Watch');
    ...
    test('Morning watch between 04:00 and 08:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'Morning Watch');
    ...
    test('Forenoon watch between 08:00 and 12:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'Forenoon Watch');
    ...
    test('Afternoon watch between 12:00 and 16:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'Afternoon Watch');
    ...
    test('First Dog watch between 16:00 and 18:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'First Dog Watch');
    ...
    test('Second Dog watch between 18:00 and 20:00', () => {
        const result = timeService.getWatches().find((watch) => watch.name === 'Second Dog Watch');
...
describe('Correct watch is returned for a given time', () => {
    ...
    describe('Current watch should be returned after the watch start time', () => {
        ...
        test('getCurrentWatch return Second Dog watch after start time', () => {
            ...
            expect(timeService.getCurrentWatch(time).name).toBe('Second Dog Watch');
        });
    });
...
describe('Correct time and bells are returned for the First Watch', () => {
    ...
    test('1 bell of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(1);
    ...
    test('2 bells of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(2);
    ...
    test('3 bells of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(3);
    ...
    test('4 bell of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(4);
    ...
    test('5 bell of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(5);
    ...
    test('6 bells of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(6);
    ...
    test('7 bells of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(7);
    ...
    test('8 bell of the First Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(8);
...
describe('Correct time and bells are returned for the Second Dog Watch', () => {
    ...
    test('1 bell of the Second Dog Watch', () => {
        ...
        expect(timeService.getBells(time)).toBe(1);
        expect(timeService.getShipsTime(time)).toBe('One bell of the Second Dog Watch');
    });

    test('2 bells of the Second Dog Watch', () => {
        const time = new Date(2025, 1, 31, 19, 0, 0, 0);
        expect(timeService.getBells(time)).toBe(2);
        expect(timeService.getShipsTime(time)).toBe('Two bells of the Second Dog Watch');
    });

    test('3 bells of the Second Dog Watch', () => {
        const time = new Date(2025, 1, 31, 19, 30, 0, 0);
        expect(timeService.getBells(time)).toBe(3);
        expect(timeService.getShipsTime(time)).toBe('Three bells of the Second Dog Watch');
    });

    test('4 bell of the Second Dog Watch', () => {
        const time = new Date(2025, 1, 31, 20, 0, 0, 0);
        expect(timeService.getBells(time)).toBe(4);
        expect(timeService.getShipsTime(time)).toBe('Four bells of the Second Dog Watch');
    });
});
